...
router.get("/email", authToken, checkRoles('admin', 'user'), async(req, res, next) => {
    try {
...
router.post("/", authToken, checkRoles('admin'), async(req, res, next) => {
    try {
...
router.delete("/:id", authToken, checkRoles('admin'), async(req, res, next) => {
    try {
